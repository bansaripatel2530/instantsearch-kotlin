package com.algolia.instantsearch.demo.util
...
import com.boxbeauty.kiosk.utils.baseinrerface.OkCancelDialogInterface
import com.sa.kiosk.utils.baseinrerface.OkCancelNeutralDialogInterface
import com.sa.kiosk.utils.baseinrerface.OkDialogInterface
...
//    fun okContinueDialog(context: Context, title: String, message: String, callback: OkContinueDialogInterface) {
//
//        val builder = AlertDialog.Builder(context)
//        builder.setTitle(title)
//        builder.setMessage(message)
...
//            callback.ok()
//        }
//        builder.setNegativeButton(context.getString(R.string.continue_shopping)) { dialog, which ->
//            dialog.dismiss()
